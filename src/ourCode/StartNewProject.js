...
function StartNewProject() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const api_name = 'StartNewProjectByLambdaIvocations';
      const path = '/startnewproject/${value1}/${value2}'; //scierzke nalerzy ustawic na taka jak wybrano podczas 'amplify api add' !!!
